          ...
          <>
            ...
            <div className="absolute bottom-8 right-8 z-20">
                <button
                 ...
                 className="p-4 rounded-full bg-black/40 border border-white/20 text-white backdrop-blur-md hover:bg-black/60 transition-colors focus-visible:ring-2 focus-visible:ring-white focus:outline-none"
                >
